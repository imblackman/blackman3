...
if data.type_.user_.username_ and not data.type_.user_.username_:match("_")
then
...
administration[tostring(arg.chat_id)]['mods'][tostring(data.id_)] = nil
   ...
   if cmd == "id" then
    ...
    text = " نتيجة ألـ [ ".. data.type_.user_.username_ .." ] :\n"
    .. ""..data.title_.."\n"
    .. " [".. data.id_ .."]"
...
return "_تم تع������ل ��تم جهات الاتصال_"
end
end
end
---------------Mute Forward-------------------
...
local gp_name = string.gsub(matches[2], "_","")local gp_name = matches[2]
...
➣ /setlang en
⇉ To change the bot replies to English ⇇

    🏳🏴➖➖ar➖➖🏴🏳

 ➣ /setlang ar
⇉ لتغير ردود البوت الى العربي  ⇇

    🏳🏴➖➖👾➖➖🏴🏳

 ➣ /add 
⇉ لتفعيل البوت في المجموعه ⇇

🏳🏴➖اوامر الرفع➖🏴🏳

⇝ /setowner ⇜⇝`[معرف|ايدي|رد]` 
_ لتعين مدير للمجموعه_
⇝ /remowner ⇜⇝`[معرف|ايدي|رد]` 
 _لحذف مدير المجموعه_
⇝ /promote ⇜⇝`[معرف|ايدي|رد]` 
_لتعين ادمن في المجموعه_
⇝ /demote ⇜⇝`[معرف|ايدي|رد]` 
_لحذف الادمن من قائمه الادمنيه_
🏳🏴➖➖👾➖➖🏴🏳
⇝ /setflood ⇜⇝`[1-50]`
_لتعين عدد التكرار_
...
⇝ /unsilent ⇜⇝`[معرف|ايدي|رد]` 
_لفك الكتم عن شخص _

⇝ /kick ⇜⇝`[معرف|ايدي|رد]` 
_لطرد الشخص من المجموعه_

⇝ /ban ⇜⇝`[معرف|ايدي|رد]` 
_لحضر الشخص في الجموعه_

⇝ /unban ⇜⇝`[معرف|ايدي|رد]` 
_لرفع الحضر عن شخص في المجموعه_

⇝ /res ⇜⇝`[معرف]`
_إظهار معرف المستخدم_

⇝ /id ⇜⇝`[رد]`
_لضهار ايدي الشخص_

⇝ /whois* `[ايدي]`
_لضهار اسم ويوزر الشخص_

🏳🏴➖اوامر قفل ➖🏴🏳

⇝ /lock* `[link | tag | edit | webpage | bots | spam | flood | markdown | mention]`

_لقفل  [الروابط | تاك | تحرير | صفحة ويب | البوتات | التكرار | الماكدرون | الخ]_

🏳🏴➖➖اوامر فتح➖➖🏴🏳

⇝ /unlock* `[link | tag | edit | webpage | bots | spam | flood | markdown | mention]`

_لفتح [الروابط | تاك | تحرير | صفحة ويب | البوتات | التكرار | الماكدرون | الخ]_

🏳🏴➖اوامر قفل الميديا➖🏴🏳

⇝ /mute* `[gifs | photo | document | sticker | video | text | forward | location | audio | voice | contact | all]`

_قفل [متحركة | الصور | وثيقة | ملصق | الفيديو | النص | اعاده توجيه | موقع  | صوت | البصمه | جميع]_

🏳🏴➖اوامر فتح الميديا➖🏴🏳

⇝ /unmute* `[gifs | photo | document | sticker | video | text | forward | location | audio | voice | contact | all]`

_ فتح [متحركة | الصور | وثيقة | ملصق | الفيديو | النص | اعاده توجيه | موقع  | صوت | البصمه | جميع]_

🏳🏴اوامر تغير معلومات المجموعه🏴🏳

⇝ /set*`[rules | name | photo | link | about]`

_لتغير بدون مسافه  [القواعد | الاسم | الصور | الرابط | حول]_

🏳🏴➖اوامر تضيف القوائم➖🏴🏳

⇝ /clean* `[bans | mods | bots | rules | about | ]`   

_ لتضيف قوائم [ الحضورين | المشرفين | البوتات | قوانين | وصف المجموعه | المكتومين ] _

🏳🏴➖اوامر تثبيت الرسائل➖🏴🏳

⇝ /pin* `[رد]`
_لتثبيت الرساله بالرد_

⇝ /unpin* 
_لحذف الرساله المثبته_

⇝ /settings*
_لضهار اعدادات المجموعه_

⇝ /mutelist*
_إظهار قائمة الميديا_

⇝ /silentlist*
_لضهار قائمه الداريون في المجموعه_

⇝ /banlist*
_بظهار قائمة المستخدمين المحضورين_

⇝ /ownerlist*
_إظهار قائمة مالكي المجموعة_ 

⇝ /modlist* 
_إظهار قائمة مجموعة المشرفين_

⇝ /rules*
_لظهار قواعد المجموعة _

⇝ /about*
_لضهار وصف المجموعه_

⇝ /id*
_لضهار ايدي و ايدي المجموعه_

⇝ /gpinfo*
_لضهار معلومات المجموعه_

⇝ /link*
_لضهار رابط المجموعه_
